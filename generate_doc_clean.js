...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: `目前，${data.enterprise}现有员工人数稳定（包括正式员工和外包），较2025年同期${data.employeeChange}。其中农民工人数占总员工比例${data.migrantRatio}，主要集中在${data.positions}。新生代与老一代农民工的比例构成为${data.ageRatio}。${data.gap}。`
        })],
        spacing: { after: 100 }
      }),
      new Paragraph({
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: '调研发现，受宏观经济形势不确定、大城市生活成本上升以及家庭照护需求等因素影响，越来越多农民工将返乡就业作为重要选项。然而，乡镇企业和欠发达地区产业基础薄弱、产业链条短、规模以上企业数量有限，难以提供足够的、有吸引力的就业岗位。一方面，现有乡镇企业多以资源初加工、来料加工或小型商贸为主，用工需求零散，且普遍存在小、散、弱特点，吸纳就业能力不足；另一方面，由于乡镇在物流、网络等基础设施配套上的先天不足，发展农村电商、现代休闲农业、乡村文旅等新业态的条件有限，就业渠道过于单一、现有岗位质量不高，导致部分农民工在返乡与外出之间反复摇摆，难以实现稳定就业。'
        })],
        spacing: { after: 200 }
      }),
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: '随着第一代农民工逐渐步入高龄阶段，我国农民工群体老龄化趋势日益凸显。一方面，由于重体力劳动对身体的长期透支，高龄农民工在工作岗位上发生机械伤害、跌倒乃至突发心脑血管疾病的概率显著增加，企业面临工伤风险上升、商业保险难覆盖等问题。调查显示，现代农业智汇大厦项目负责人表示，目前厂区一线普工的平均年龄适中，由于部分工人超龄无法缴纳常规工伤保险，企业不得不每年额外掏出数万元购买商业意外险。另一方面，受高危行业清退令及安全生产规范限制，大批高龄熟练工被迫退出一线，而新生代农民工对枯燥、高强度、无保障的岗位接受度较低，导致企业一线岗位青黄不接，面临无人可用的局面。调查显示，现代农业智汇大厦项目负责人表示，即便开出较高的日薪，也难以招聘到愿意干活的年轻人。'
        })],
        spacing: { after: 200 }
      }),
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: '以现代农业智汇大厦项目为例，该企业采用劳务外包用工模式，农民工流动性极强，劳动合同签订比例仅为0%-50%。调研显示，该企业不存在农民工用工缺口，但员工稳定性极差——农民工多以短期务工为主，项目周期短、人员流动快，干一天算一天的零工特征明显。企业坦言，制约签订合同的主要因素是农民工流动性强，短期务工为主，部分工人干几天就要去找别的活干，觉得签合同反而受约束。这种高流动性直接导致劳动关系高度碎片化，农民工难以建立稳定的雇佣预期。'
        })],
        spacing: { after: 200 }
      }),
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: '现代农业智汇大厦项目农民工社保参保比例仅为0%-50%，且企业未为农民工购买任何保险。调研显示，制约参保的主要因素包括：农民工主动要求不参保（换取更多现金收入），以及农民工流动性强，参保接续不便。企业若顺应工人要求不签合同、不缴社保，将面临合规风险；若强制缴纳，则会导致工人流失，陷入两难困境。此外，子女教育问题成为农民工离职返乡的重要推手——该企业明确表示，子女无法在务工地入学或参加高考是农民工选择离开的主要原因，公共服务可及性不足直接导致家庭化迁移受阻。'
        })],
        spacing: { after: 300 }
      }),
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: '针对建筑业等劳务外包普遍、用工流动性强的行业，建议建立按项目参保的工伤保险制度，允许农民工按工程项目而非按劳动关系参加工伤保险，解决干一天算一天零工模式下无保障的问题。同时，探索建立农民工工资支付保障金制度和用工实名制平台，将劳动合同签订、考勤记录、工资发放等信息纳入平台监管，既保障农民工合法权益，又为企业规范用工提供抓手。对于短期务工人员，可推行电子劳动合同+灵活社保模式，降低参保门槛，实现干一天保一天，提高农民工参保意愿。'
        })],
        spacing: { after: 200 }
      }),
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: '针对农民工流动性强、参保接续不便的核心痛点，建议进一步优化全国社保转移接续平台功能，实现养老保险、医疗保险跨省转移一网通办，缩短办理时限，降低转移成本。对于建筑业等季节性用工行业，探索建立个人账户+统筹账户分离机制，允许农民工个人账户随人走、统筹账户分段计，确保缴了不白缴。同时，加大对企业社保补贴力度，对吸纳农民工就业并依法参保的企业给予社保费率优惠或专项补贴，降低企业用工成本，提高企业参保积极性，从根本上扭转企业不愿缴、工人不想缴的双重困局。'
        })],
        spacing: { after: 200 }
      }),
      ...
      new Paragraph({
        children: [new TextRun({ 
          text: '针对子女无法在务工地入学或参加高考这一导致农民工返乡的核心痛点，建议深化户籍制度改革，推动教育、医疗等公共服务与户籍逐步脱钩，建立以居住证为主要依据的公共服务供给制度。在义务教育阶段，进一步降低农民工随迁子女入学门槛，扩大公办学校接收容量，保障应入尽入；在升学考试阶段，扩大随迁子女在务工地参加中考、高考的范围，逐步打破高考移民限制。同时，加大对农民工聚居区教育资源的投入，通过新建、改扩建学校，增加学位供给，让农民工子女有学上、上好学，从源头上减少因子女教育问题导致的被迫返乡，稳定企业用工队伍。'
        })],
        spacing: { after: 200 }
      }),
    ]
